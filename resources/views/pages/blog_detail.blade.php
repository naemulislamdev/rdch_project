...
@section('content')
    ...
    <div class="banner-slider" style="background-image: url({{ asset('public/uploads/'.$g_setting->banner_blog_detail) }})">
        <div class="bg"></div>
                ...
                <div class="col-md-8 wow fadeIn" data-wow-delay="0.1s">
                    <div class="single-blog mt_30">
                        <div class="blog-image mb_30">
                            <img src="{{ asset('public/uploads/'.$blog_detail->blog_photo) }}" alt="Blog Image">
                            <div class="date">

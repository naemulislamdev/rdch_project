...
@section('content')
    ...
    <div class="banner-slider" style="background-image: url({{ asset('public/uploads/'.$g_setting->banner_team_member_detail) }})">
        <div class="bg"></div>
            ...
            <div class="row">
                <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-detail-photo mt_30">
                        <img src="{{ asset('public/uploads/'.$team_member_detail->photo) }}" alt="Team Photo">
                    ...
                    <div class="team-carousel owl-carousel">
                        ...
                        <div class="team-item wow fadeIn" data-wow-delay="0.1s">
                            <div class="team-photo">
                                ...
                                <img src="{{ asset('public/uploads/'.$row->photo) }}" alt="Team Photo">

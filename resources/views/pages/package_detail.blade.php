...
@section('content')
    <div class="banner-slider" style="background-image: url({{ asset('public/uploads/'.$g_setting->banner_package) }})">
        <div class="bg"></div>
                                    ...
                                    <div class="col-md-4 col-xs-6 clear-three col-item">
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-text">
                                                <a href="{{ asset('public/uploads/'.$row->photo) }}" class="magnific"><i class="fa fa-search-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach

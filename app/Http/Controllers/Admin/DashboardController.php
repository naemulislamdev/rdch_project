...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.home', compact('total_post','total_services','total_team_members','total_destinations','total_packages','total_completed_orders','total_pending_orders'));
    }
}

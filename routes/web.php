...
use App\Http\Controllers\Admin\ForeignStudentController;
use App\Http\Controllers\Admin\NoticeController;
use App\Http\Controllers\Admin\OrderController as OrderControllerForAdmin;
use App\Http\Controllers\Admin\WebSectionController;
...
Route::controller(FrontendController::class)->group(function(){
    ...
    Route::get('/message-from-chairman', 'msgChairman')->name('msg_chairman');
    Route::get('/message-from-principal', 'msgPrinciple')->name('msg_principle');
    Route::get('/message-from-managing-director', 'msgDirector')->name('msg_director');
    Route::get('/board-of-director', 'boardDirector')->name('board_director');
});
...
Route::get('service', [ServiceControllerForFront::class,'index'])->name('front.services');
...
//Admin Notice route
Route::controller(NoticeController::class)->prefix('admin/')->group(function(){
    Route::get('notice/index','index')->name('admin.notice.index');
    Route::get('notice/create','create')->name('admin.notice.create');
    Route::post('notice/store','store')->name('admin.notice.store');
    Route::get('notice/edit/{notice}','edit')->name('admin.notice.edit');
    Route::put('notice/update/{notice}','update')->name('admin.notice.update');
    Route::get('notice/destroy/{notice}','destroy')->name('admin.notice.destroy');
    Route::put('notice/status/{notice}','status')->name('admin.notice.status');
});
//Admin Foreign student route
Route::controller(ForeignStudentController::class)->prefix('admin/')->group(function(){
    Route::get('foreign-student/index','index')->name('admin.foreign_student.index');
    Route::get('foreign-student/create','create')->name('admin.foreign_student.create');
    Route::post('foreign-student/store','store')->name('admin.foreign_student.store');
    Route::get('foreign-student/edit/{foreignStudent}','edit')->name('admin.foreign_student.edit');
    Route::put('foreign-student/update/{foreignStudent}','update')->name('admin.foreign_student.update');
    Route::get('foreign-student/destroy/{foreignStudent}','destroy')->name('admin.foreign_student.destroy');
    Route::put('foreign-student/status/{foreignStudent}','status')->name('admin.foreign_student.status');
    Route::get('foreign-student/front-status/{foreignStudent}','frontStatus')->name('admin.foreign_student.front_status');
});
//Admin Foreign student route
Route::controller(WebSectionController::class)->prefix('admin/')->group(function(){
    Route::get('chairman/index','chairmanIndex')->name('admin.chairman.index');
    Route::post('chairman/update/{chairman?}','chairmanUpdate')->name('admin.chairman.update');
});
